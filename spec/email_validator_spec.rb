...
RSpec.describe EmailValidator do
  ...
  it "validates a name and email pair" do
    expect(@validator.valid?(nil, nil, "Foo Bar <foo@bar.com>")).to be(true)
  end

  it "uses a full RFC 5322 syntax when configured" do
  ...
  it "does not validate an improper email address" do
  ...
  it "does not validate an improper name and email pair" do
